...
class ExpansionListAdapter(context: Context, cursor: Cursor) : CursorAdapter(context, cursor, 0) {
...
class ExpansionsActivity : AppCompatActivity() {
    private lateinit var dbHelper: ExpansionDatabaseHelper
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        dbHelper = ExpansionDatabaseHelper(this)
